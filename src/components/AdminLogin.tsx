    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="w-16 h-16 rounded-full bg-linear-to-br from-amber-400 to-orange-500 flex items-center justify-center mb-4">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">
            {verifying ? 'Verifying...' : 'Enter your admin PIN'}
          </p>
        </div>
